...
namespace Payroller
{
    public partial class Riesgos : Form
    {
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string create = "insert into Riesgos values ('" +
                txtNombre.Text + "','" +
                txtDescripcion.Text + "')";
        ...
        {
            string update = "update Riesgos set Nombre= '" + txtNombre.Text + "', Descripcion= '" + txtDescripcion.Text + "' where ID= " + txtID.Text;
        ...
        {
            {
                string delete = "delete from Riesgos where ID= " + txtID.Text;
        ...
        private void Riesgos_Load(object sender, EventArgs e)
        {
